...
public class GeneradorCodigos {
    ...
    public GeneradorCodigos(String codigoletras, String codigonums, String codigotickets, int dimletras, int letraaleatoria, String letras, int numaleatorio, String nums, int totalentradas, int i, int j, int k, String matriz) {
